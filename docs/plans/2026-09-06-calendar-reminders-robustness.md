...
Status, September 9: spike selected Branch B; `ensure_access()` was rejected.
Tasks 3–10 are implemented and integrated with P01/P02. The ten-minute booking
cache is superseded by durable operation identity/recovery. Native signed permission
qualification remains P06. Original outage wording and estimates below are historical;
see the [integration handoff](../production/handoffs/2026-09-09-branch-integration.md).
