...
REASONS = {'rate_limited','signin_required','subscription_required','allowance_exhausted','provider_unavailable','permission_required','outcome_uncertain','request_conflict',None, 'user_paused', 'keychain_locked', 'storage_unavailable', 'permission_denied',
