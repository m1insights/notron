...
from juno import conversation, markup, watch, workspace
...
HEADER = "Type anything below this line and Juno will answer underneath it."
...
def test_the_message_that_was_lost_is_now_found():
    ...
    body = ask_note(f"{HEADER}\n\nHi Juno. How are you? I am about to read a book.\n\n"
...
def test_a_restart_does_not_lose_a_tag(tmp_path, monkeypatch):
    """If you write #juno and the Mac reboots before she gets to it, she still
    owes you an answer."""
    from juno import mentions
...
def test_what_is_still_owed_survives_a_restart(tmp_path, monkeypatch):
    ...
    from juno import markup, mentions
    monkeypatch.setattr(mentions, "STATE", tmp_path / "seen.json")
